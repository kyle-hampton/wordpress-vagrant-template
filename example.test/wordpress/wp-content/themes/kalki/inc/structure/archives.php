...
if ( ! function_exists( 'kalki_archive_title' ) ) {
	add_action( 'kalki_archive_title', 'kalki_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function kalki_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * kalki_before_archive_title hook.
			 *
			 */
			do_action( 'kalki_before_archive_title' );
			?>
			...
			<?php
			/**
			 * kalki_after_archive_title hook.
			 *
			 */
			do_action( 'kalki_after_archive_title' );
			...
			/**
			 * kalki_after_archive_description hook.
			 *
			 */
			do_action( 'kalki_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'kalki_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'kalki_filter_the_archive_title' );
	/**
	 ...
	 */
	function kalki_filter_the_archive_title( $title ) {
		if ( is_category() ) {
