...
if ( ! function_exists( 'kalki_social_bar' ) ) {
	add_action( 'kalki_social_bar_action', 'kalki_social_bar' );
	function kalki_social_bar() {
		$socials_facebook_url  		=  kalki_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  kalki_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  kalki_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  kalki_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  kalki_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  kalki_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  kalki_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  kalki_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  kalki_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  kalki_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  kalki_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  kalki_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  kalki_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  kalki_get_setting( 'socials_mail_url' );
	?>
