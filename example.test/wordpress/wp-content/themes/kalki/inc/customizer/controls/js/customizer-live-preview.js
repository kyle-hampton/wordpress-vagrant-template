 ...
 */
function kalki_colors_live_update( id, selector, property, default_value ) {
	default_value = typeof default_value !== 'undefined' ? default_value : 'initial';
	wp.customize( 'kalki_settings[' + id + ']', function( value ) {
...
function kalki_classes_live_update( id, classes, selector, prefix ) {
...
( function( $ ) {
	...
	wp.customize( 'background_image', function( value ) {
		value.bind( function( newval ) {
			$(".kalki-side-padding-inside").css({"background-image": "url(" + newval + ")"});
		} );
	} );
	...
	wp.customize( 'background_repeat', function( value ) {
		value.bind( function( newval ) {
			$(".kalki-side-padding-inside").css({"background-repeat": newval });
		} );
	} );
	...
	wp.customize( 'background_size', function( value ) {
		value.bind( function( newval ) {
			$(".kalki-side-padding-inside").css({"background-size": newval });
		} );
	} );
	 ...
	 * Empty:  black
	 */
	kalki_colors_live_update( 'side_inside_color', '.kalki-side-padding-inside', 'background-color', '#000000' );

	/**
	 * Text color
	 * Empty:  black
	 */
	kalki_colors_live_update( 'text_color', 'body', 'color', '#000000' );

	/**
	 * Link color
	 * Empty:  initial
	 */
	kalki_colors_live_update( 'link_color', 'a, a:visited', 'color', 'initial' );

	/**
	 * Link color hover
	 * Empty:  initial
	 */
	kalki_colors_live_update( 'link_color_hover', 'a:hover', 'color', 'initial' );

	/**
	 * Container width
	 */
	wp.customize( 'kalki_settings[container_width]', function( value ) {
		value.bind( function( newval ) {
			...
			jQuery('body').trigger('kalki_spacing_updated');
		} );
	} );
	 ...
	 * Body font size
	 */
	wp.customize( 'kalki_settings[body_font_size]', function( value ) {
		value.bind( function( newval ) {
			...
			setTimeout("jQuery('body').trigger('kalki_spacing_updated');", 1000);
		} );
	} );
	 ...
	 * Body line height
	 */
	wp.customize( 'kalki_settings[body_line_height]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Paragraph margin
	 */
	wp.customize( 'kalki_settings[paragraph_margin]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Body font weight
	 */
	wp.customize( 'kalki_settings[body_font_weight]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Body text transform
	 */
	wp.customize( 'kalki_settings[body_font_transform]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Content layout
	 */
	kalki_classes_live_update( 'content_layout_setting', [ 'one-container', 'separate-containers' ], 'body' );

	/**
	 * Top bar width
	 */
	wp.customize( 'kalki_settings[top_bar_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value('kalki_settings[top_bar_inner_width]')() ) {
	 ...
	 * Inner top bar width
	 */
	wp.customize( 'kalki_settings[top_bar_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full' == newval ) {
				$( '.inside-top-bar' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
			}
	 ...
	 * Top bar alignment
	 */
	kalki_classes_live_update( 'top_bar_alignment', [ 'left', 'center', 'right' ], '.top-bar', 'top-bar-align-' );

	/**
	 * Header layout
	 */
	wp.customize( 'kalki_settings[header_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			if ( 'fluid-header' == newval ) {
				$( '.site-header' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
				if ( 'contained' == wp.customize.value('kalki_settings[header_inner_width]')() ) {
	 ...
	 * Inner Header layout
	 */
	wp.customize( 'kalki_settings[header_inner_width]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Header alignment
	 */
	kalki_classes_live_update( 'header_alignment_setting', [ 'left', 'center', 'right' ], 'body', 'header-aligned-' );

	/**
	 * Navigation width
	 */
	wp.customize( 'kalki_settings[nav_layout_setting]', function( value ) {
		value.bind( function( newval ) {
			if ( $( 'body' ).hasClass( 'sticky-enabled' ) ) {
				...
				if ( 'fluid-nav' == newval ) {
					...
					if ( 'full-width' !== wp.customize.value('kalki_settings[nav_inner_width]')() ) {
	 ...
	 */
	wp.customize( 'kalki_settings[nav_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
				$( '.main-navigation .inside-navigation' ).removeClass( 'grid-container' ).removeClass( 'grid-parent' );
			}
	 ...
	 * Navigation position
	 */
	wp.customize( 'kalki_settings[nav_position_setting]', function( value ) {
		value.bind( function( newval ) {
			jQuery('body').trigger('kalki_navigation_location_updated');
	 ...
	 */
	kalki_classes_live_update( 'nav_alignment_setting', [ 'left', 'center', 'right' ], 'body', 'nav-aligned-' );

	/**
	 * Footer width
	 */
	wp.customize( 'kalki_settings[footer_layout_setting]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * Inner footer width
	 */
	wp.customize( 'kalki_settings[footer_inner_width]', function( value ) {
		value.bind( function( newval ) {
			if ( 'full-width' == newval ) {
	 ...
	 */
	kalki_classes_live_update( 'footer_bar_alignment', [ 'left', 'center', 'right' ], '.site-footer', 'footer-bar-align-' );
