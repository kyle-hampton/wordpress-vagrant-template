...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Kalki_Range_Slider_Control' ) ) {
	/**
	 * Create a range slider control.
	 * This control allows you to add responsive settings.
	 *
	 */
	class Kalki_Range_Slider_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @var string
		 */
		public $type = 'kalki-range-slider';
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = __( 'Desktop','kalki' );
			$this->json['tablet_label'] = __( 'Tablet','kalki' );
			$this->json['mobile_label'] = __( 'Mobile','kalki' );
			$this->json['reset_label'] = __( 'Reset','kalki' );
		...
		public function enqueue() {
			wp_enqueue_script( 'kalki-range-slider', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/controls/js/slider-control.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), false, true );
			wp_enqueue_style( 'kalki-range-slider-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/controls/css/slider-customizer.css', null );
		}
		...
		protected function content_template() {
			?>
			<div class="kalki-range-slider-control">
				<div class="kalki-range-title-area">
					<# if ( data.label || data.description ) { #>
						<div class="kalki-range-title-info">
							<# if ( data.label ) { #>
					...
					<div class="kalki-range-slider-controls">
						<span class="kalki-device-controls">
							<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
								<span class="kalki-device-desktop dashicons dashicons-desktop" data-option="desktop" title="{{ data.desktop_label }}"></span>
							<# } #>

							<# if ( 'undefined' !== typeof (data.tablet) ) { #>
								<span class="kalki-device-tablet dashicons dashicons-tablet" data-option="tablet" title="{{ data.tablet_label }}"></span>
							<# } #>

							<# if ( 'undefined' !== typeof (data.mobile) ) { #>
								<span class="kalki-device-mobile dashicons dashicons-smartphone" data-option="mobile" title="{{ data.mobile_label }}"></span>
							<# } #>
						</span>

						<span title="{{ data.reset_label }}" class="kalki-reset dashicons dashicons-image-rotate"></span>
					</div>
				</div>

				<div class="kalki-range-slider-areas">
					<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
						<label class="range-option-area" data-option="desktop" style="display: none;">
							<div class="wrapper <# if ( '' !== data.choices['desktop']['unit'] ) { #>has-unit<# } #>">
								<div class="kalki_range_value <# if ( '' == data.choices['desktop']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
								...
								<div class="kalki-slider" data-step="{{ data.choices['desktop']['step'] }}" data-min="{{ data.choices['desktop']['min'] }}" data-max="{{ data.choices['desktop']['max'] }}"></div>
							</div>
						</label>
					<# } #>
					...
					<# if ( 'undefined' !== typeof ( data.tablet ) ) { #>
						<label class="range-option-area" data-option="tablet" style="display:none">
							<div class="wrapper <# if ( '' !== data.choices['tablet']['unit'] ) { #>has-unit<# } #>">
								<div class="kalki_range_value <# if ( '' == data.choices['tablet']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
								...
								<div class="kalki-slider" data-step="{{ data.choices['tablet']['step'] }}" data-min="{{ data.choices['tablet']['min'] }}" data-max="{{ data.choices['tablet']['max'] }}"></div>
							</div>
						</label>
					<# } #>
					...
					<# if ( 'undefined' !== typeof ( data.mobile ) ) { #>
						<label class="range-option-area" data-option="mobile" style="display:none;">
							<div class="wrapper <# if ( '' !== data.choices['mobile']['unit'] ) { #>has-unit<# } #>">
								<div class="kalki_range_value <# if ( '' == data.choices['mobile']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
								...
								<div class="kalki-slider" data-step="{{ data.choices['mobile']['step'] }}" data-min="{{ data.choices['mobile']['min'] }}" data-max="{{ data.choices['mobile']['max'] }}"></div>
							</div>
						</label>
					<# } #>
				</div>
